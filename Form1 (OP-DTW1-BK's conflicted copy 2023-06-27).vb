...
Public Class Form1
    ...
    Private Sub MasterPlayLoop()
        ...
        If DJ = "ThreeDog" Then
            ...
            ChooseNewsIntro()
            ChooseNews()
            For X As Integer = 1 To txtSongCountPer.Text
                ChooseSongs()
            Next X
            ' ChooseSongs()
    ...
    Private Sub ChooseNews()
        ...
        If (ckbRandomPlayerStats.Checked Or rdbKarmaRND.Checked Or rdbGenderRandom.Checked Or PlayerLevel = 0) And ckbPlayerStatsEnable.Checked Then
    ...
    Private Sub GetMainQuestCompleted()
        ...
        ElseIf rdbMQuestSV.Checked Then 'Shock Value
            MainQuestCompleted = "MQuestSV_" & PlayerGender
    ...
    Private Sub txtSongCountPer_TextChanged(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txtSongCountPer.KeyPress
    ...
    Private Sub SaveFile()
        ...
        End If
        txtRWSettings.Text &= ckbDashwood.Checked & ";" & txbDashwoodPercent.Text & ";" & ckbOtherMusic.Checked & ";" & txtSongCountPer.Text & ";"
    ...
    Private Sub LoadFile()
        ...
        End If
        txtSongCountPer.Text = lbxRWSettings.Items(5)
